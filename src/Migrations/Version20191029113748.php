 ...
 */
final class Version20191029113748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ge_user DROP reset_token');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ge_user ADD reset_token VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
