  ...
  (e = (function() {
    ...
    return (
      (e.prototype.add_node = function(e) {
        return e.nodeName.toUpperCase() === "OPTGROUP"
          ? this.add_group(e)
          : this.add_option(e);
      }),
            ...
            return this.options.width != null
              ...
              : ((e =
                  window.getComputedStyle != null
                    ...
                    ? this.form_field_jq.outerWidth()
                    : this.form_field.getWidth()),
                e + "px");
          }),
          (e.browser_is_supported = function() {
            var e;
            return window.navigator.appName === "Microsoft Internet Explorer"
              ? null !== (e = document.documentMode) && e >= 8
              : !0;
          }),
        ...
        return (
          ...
          (n.prototype.set_up_html = function() {
            ...
            return (
              ...
              this.results_build(),
              this.set_tab_index(),
              this.form_field_jq.trigger("liszt:ready", { chosen: this })
            );
          }),
                  ...
                  this.active_field
                    ? !this.is_multiple &&
                      ...
                      (e(t.target)[0] === this.selected_item[0] ||
                        e(t.target).parents("a.chzn-single").length) &&
          ...
          (n.prototype.test_active_click = function(t) {
            return e(t.target).parents("#" + this.container_id).length
              ? (this.active_field = !0)
              : this.close_field();
          }),
          (n.prototype.results_build = function() {
            var e, t, n, i, s;
            (this.parsing = !0),
              (this.results_data = r.SelectParser.select_to_array(
                this.form_field
              )),
              this.is_multiple && this.choices > 0
          ...
          (n.prototype.choices_click = function(t) {
            ...
            if (
              this.active_field &&
              !e(t.target).hasClass("search-choice") &&
              !this.results_showing
            )
              ...
              return (
                ...
                this.is_multiple
                  ...
                  : (this.selected_item
                    ...
                    this.allow_single_deselect &&
                      this.single_deselect_control_build()),
                ((!e.metaKey && !e.ctrlKey) || !this.is_multiple) &&
                  this.results_hide(),
                this.search_field.val(""),
                (this.is_multiple ||
          ...
          (n.prototype.result_deselect = function(t) {
            ...
            return (
              ...
              this.form_field.options[r.options_index].disabled
                ? !1
                : ((r.selected = !1),
                  (this.form_field.options[r.options_index].selected = !1),
              ...
              if (!n.disabled && !n.empty)
                if (n.group) e("#" + n.dom_id).css("display", "none");
                  ...
                  if (s.test(n.html)) (t = !0), (f += 1);
                    ...
                    this.enable_split_word_search &&
                    (n.html.indexOf(" ") >= 0 || n.html.indexOf("[") === 0)
                  ) {
                  ...
                  t
                    ? (l.length
                        ? ((c = n.html.search(p)),
                          (h =
                            n.html.substr(0, c + l.length) +
                            "</em>" +
                            n.html.substr(c + l.length)),
                          (h = h.substr(0, c) + "<em>" + h.substr(c)))
                        : (h = n.html),
                      u.html(h),
                      this.result_activate(u),
                      n.group_array_index != null &&
                        e(
                          "#" + this.results_data[n.group_array_index].dom_id
                        ).css("display", "list-item"))
                    : (this.result_highlight &&
                        a === this.result_highlight.attr("id") &&
                        this.result_clear_highlight(),
          ...
          (n.prototype.winnow_results_clear = function() {
            ...
            for (r = 0, i = n.length; r < i; r++)
              (t = n[r]),
                (t = e(t)),
                t.hasClass("group-result")
                  ? s.push(t.css("display", "auto"))
                  : !this.is_multiple || !t.hasClass("result-selected")
          ...
          (n.prototype.keydown_arrow = function() {
            ...
            this.result_highlight
              ? this.results_showing &&
                ((n = this.result_highlight
                  .nextAll("li.active-result")
                  .first()),
                n && this.result_do_highlight(n))
              : ((t = this.search_results.find("li.active-result").first()),
                t && this.result_do_highlight(e(t)));
          ...
          (n.prototype.search_field_scale = function() {
            ...
            if (this.is_multiple) {
              ...
              for (u = 0, a = s.length; u < a; u++)
                (r = s[u]), (i += r + ":" + this.search_field.css(r) + ";");
              return (
                (t = e("<div />", { style: i })),
